...
public class BookRepository {
    ...
    //filtrerar ut de 10 mest populära böckerna
    public ArrayList<Book> getPopularBooks() {
        ...
        try (Connection conn = DriverManager.getConnection(URL, USER, PASS);
            ...
            ResultSet rs = stmt.executeQuery("SELECT b.title, b.year_published, b.available_copies, bd.summary, bd.language, bd.page_count, a.first_name, a.last_name, COUNT(l.book_id) AS loan_count FROM books b JOIN book_descriptions bd ON bd.book_id=b.id JOIN book_authors ba ON b.id=ba.book_id JOIN authors a ON a.id=ba.author_id JOIN loans l ON l.book_id=b.id GROUP BY b.id, b.title, b.year_published, b.available_copies, bd.summary, bd.language, bd.page_count, a.first_name, a.last_name ORDER BY loan_count DESC LIMIT 10");
