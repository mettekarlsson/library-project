...
public class BookRepository {
    ...
    public ArrayList<Book> getAllAvailableBooks() {
        ...
        try (Connection conn = DriverManager.getConnection(URL, USER, PASS);
            ...
            ResultSet rs = stmt.executeQuery("SELECT b.title, b.year_published, b.available_copies, bd.summary, bd.language, bd.page_count, a.first_name, a.last_name FROM books b JOIN book_descriptions bd ON bd.book_id=b.id JOIN book_authors ba ON b.id=ba.book_id JOIN authors a ON a.id=ba.author_id WHERE b.available_copies > 0");
